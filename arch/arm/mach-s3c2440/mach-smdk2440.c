...
static struct s3c2410_nand_set fl2440_nand_sets[]={
	[0]={
		...
		.partitions= fl2440_default_nand_part,
	},
};
...
static struct platform_device *fl2440_devices[] __initdata = {	
	...
	&s3c_device_usb,
	&fl2440_device_eth,
};//&s3c_device_lcd, &s3c_device_iis,&s3c_device_usb,
	//fl2440_device_eth:自定义网络设备
...
MACHINE_START(S3C2440, "FL2440")
//MACHINE_START(GPI, "FL2440")
